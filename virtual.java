...
import java.util.Scanner;
	...
	public class virtual{
	    public static void main(String[] args) {
	        File folder = new File("C:\\Users\\sonam\\Desktop\\FINALproject");
	        folder.mkdirs(); 
	        ...
	        while(true){
	            ...
	            System.out.println("*****Select one of the option which is mention above***** \n");
	            ...
	            switch(choice)
	            {
	                ...
	                case 2:
	                    ...
	                    while(temp) {
	                        ...
	                        switch (choice2) {
	                            case 1:
	                                File f = new File("C:\\Users\\sonam\\Desktop\\FINALproject");
